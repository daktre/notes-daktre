...
<figure>
  <iframe 
    src="https://birdtunes.net/?station=22410" 
    style="width:100%; height:600px; border:none; border-radius: 8px;" 
    allow="autoplay">
  </iframe>
  <figcaption style="text-align: center; color: gray; font-size: 0.9em; margin-top: 8px;">
    Scroll through list of birds currently recorded at my station via the birdtunes.net live-feed
  </figcaption>
</figure>
...
<figure>
<iframe 
  src="https://app.birdweather.com/" 
  style="width:100%; height:600px; border:none;">
</iframe>
<figcaption style="text-align: center; color: gray; font-size: 0.9em; margin-top: 8px;">
	Explore map of all Birdweather recording stations currenlty active
	</figcaption>
	</figure>
